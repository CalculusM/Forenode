...
# ※ avg 6.41% = MRG 시대(9~12%) 포함 전 기간 평균(세후). 화면 기본 벤치마크는
#   RR-25-10 운영 중 23개 평균 5.60%(실질·세후)를 사용('26-09-17 B5 정정).
MARKET_AGREED_RETURNS = {
    ...
    "source": "KOTI RR-24-12 pp.52-53 (도로 54건 약정 사업수익률·세후) · "
              ...
              "6.41%는 MRG 시대 포함 전 기간 평균(세후), 화면 기본 벤치마크는 "
              "RR-25-10 운영 평균 5.60%(실질·세후)",
}
